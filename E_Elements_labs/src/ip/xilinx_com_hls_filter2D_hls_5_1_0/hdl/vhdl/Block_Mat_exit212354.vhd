...
entity Block_Mat_exit212354 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_Mat_exit212354 is 
    ...
    signal col_packets_fu_76_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal grp_fu_92_p0 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal grp_fu_92_p00 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((col_packets_cast_out_out_full_n = ap_const_logic_0) or (col_packets_out_out_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    begin
                ap_block_state1 <= ((col_packets_cast_out_out_full_n = ap_const_logic_0) or (col_packets_out_out_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_return_assign_proc : process(grp_fu_92_p2, ap_CS_fsm_state5, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            ap_return <= grp_fu_92_p2;
        else 
    ...
    col_packets_cast_out_out_din <= cols(31 downto 2);
    ...
    col_packets_fu_76_p4 <= cols(31 downto 2);
    ...
    col_packets_out_out_din <= cols(31 downto 2);
    ...
    grp_fu_92_ce_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, col_packets_out_out_full_n, col_packets_cast_out_out_full_n)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and ((col_packets_cast_out_out_full_n = ap_const_logic_0) or (col_packets_out_out_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1)))) then 
    ...
    grp_fu_92_p0 <= grp_fu_92_p00(30 - 1 downto 0);
    grp_fu_92_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(col_packets_fu_76_p4),32));
end behav;
