...
entity Block_Mat_exit38793_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_Mat_exit38793_s is 
...
begin
    ...
    ap_return_assign_proc : process(grp_fu_158_p2, ap_CS_fsm_state11, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            ap_return <= grp_fu_158_p2;
        else 
    ...
    grp_fu_158_ce_assign_proc : process(col_packets_out_out_full_n, col_packets_cast_out_out_full_n, ap_CS_fsm_state7, ap_CS_fsm_state8, ap_CS_fsm_state9, ap_CS_fsm_state10, ap_CS_fsm_state11)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) or (ap_const_logic_1 = ap_CS_fsm_state10) or (ap_const_logic_1 = ap_CS_fsm_state9) or (ap_const_logic_1 = ap_CS_fsm_state8) or (not(((col_packets_cast_out_out_full_n = ap_const_logic_0) or (col_packets_out_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state7)))) then 
    ...
    tmp_36_fu_96_p3 <= grp_fu_90_p2(31 downto 31);
