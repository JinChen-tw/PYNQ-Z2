...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state10) | (1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (~((col_packets_cast_out_out_full_n == 1'b0) | (col_packets_out_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state7)))) begin
        grp_fu_158_ce = 1'b1;
    end else begin
        grp_fu_158_ce = 1'b0;
    end
