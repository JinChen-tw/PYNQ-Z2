...
#set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports hdmi_out_ddc_scl_io]
#set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS33} [get_ports hdmi_out_ddc_sda_io]
