...
# <./lab1/lab1.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project lab1 lab1 -part xc7z020clg400-1
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins testloop_0/ap_rst_n]
...
create_root_design ""
make_wrapper -files [get_files ./lab1/lab1.srcs/sources_1/bd/lab1/lab1.bd] -top
add_files -norecurse ./lab1/lab1.srcs/sources_1/bd/lab1/hdl/lab1_wrapper.v
set_property top lab1_wrapper [current_fileset]
