...
# source lab3_project.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./lab3_project/lab3_project.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project lab3_project lab3_project -part xc7z020clg400-1
}
...
create_root_design ""
make_wrapper -files [get_files ./lab3_project/lab3_project.srcs/sources_1/bd/lab3_project/lab3_project.bd] -top
add_files -norecurse ./lab3_project/lab3_project.srcs/sources_1/bd/lab3_project/hdl/lab3_project_wrapper.v
set_property top lab3_project_wrapper [current_fileset]
