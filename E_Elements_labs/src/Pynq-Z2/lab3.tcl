...
if { $list_projs eq "" } {
   create_project lab3 lab3 -part xc7z020clg400-1
}
...
proc create_hier_cell_image_filters { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins axis_interconnect_2/S00_AXIS] [get_bd_intf_pins filter2D_hls_0/out_stream]
  ...
  connect_bd_intf_net -intf_net S01_AXIS_1 [get_bd_intf_pins axis_interconnect_2/S01_AXIS] [get_bd_intf_pins filter2D_hls_5_0/out_stream]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_2_M02_AXI [get_bd_intf_pins axi_interconnect_2/M02_AXI] [get_bd_intf_pins filter2D_hls_0/s_axi_CONTROL_BUS]
  connect_bd_intf_net -intf_net axi_interconnect_2_M03_AXI [get_bd_intf_pins axi_interconnect_2/M03_AXI] [get_bd_intf_pins filter2D_hls_5_0/s_axi_CONTROL_BUS]
  connect_bd_intf_net -intf_net axi_interconnect_2_M04_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_2/M04_AXI]
  connect_bd_intf_net -intf_net axis_interconnect_1_M00_AXIS [get_bd_intf_pins axis_interconnect_1/M00_AXIS] [get_bd_intf_pins filter2D_hls_0/in_stream]
  connect_bd_intf_net -intf_net axis_interconnect_1_M01_AXIS [get_bd_intf_pins axis_interconnect_1/M01_AXIS] [get_bd_intf_pins filter2D_hls_5_0/in_stream]
  ...
  # Create port connections
  connect_bd_net -net ap_clk1_1 [get_bd_pins clk_142M] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_2/M02_ACLK] [get_bd_pins axi_interconnect_2/M03_ACLK] [get_bd_pins axi_interconnect_2/M04_ACLK] [get_bd_pins axis_interconnect_1/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_1/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_1/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_2/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_2/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_2/S01_AXIS_ACLK] [get_bd_pins filter2D_hls_0/AXI_LITE_clk] [get_bd_pins filter2D_hls_0/ap_clk] [get_bd_pins filter2D_hls_5_0/AXI_LITE_clk] [get_bd_pins filter2D_hls_5_0/ap_clk]
  connect_bd_net -net ap_rst_n1_1 [get_bd_pins clk_142M_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_2/M02_ARESETN] [get_bd_pins axi_interconnect_2/M03_ARESETN] [get_bd_pins axi_interconnect_2/M04_ARESETN] [get_bd_pins axis_interconnect_1/M00_AXIS_ARESETN] [get_bd_pins axis_interconnect_1/M01_AXIS_ARESETN] [get_bd_pins axis_interconnect_1/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_2/M00_AXIS_ARESETN] [get_bd_pins axis_interconnect_2/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_2/S01_AXIS_ARESETN] [get_bd_pins filter2D_hls_0/ap_rst_n] [get_bd_pins filter2D_hls_0/ap_rst_n_AXI_LITE_clk] [get_bd_pins filter2D_hls_5_0/ap_rst_n] [get_bd_pins filter2D_hls_5_0/ap_rst_n_AXI_LITE_clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_interconnect_2/S00_ARB_REQ_SUPPRESS] [get_bd_pins axis_interconnect_2/S01_ARB_REQ_SUPPRESS] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net image_filters_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins image_filters/M_AXI_MM2S]
  connect_bd_intf_net -intf_net image_filters_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_1/S01_AXI] [get_bd_intf_pins image_filters/M_AXI_S2MM]
  ...
  connect_bd_net -net proc_sys_reset_fclk1_interconnect_aresetn [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins proc_sys_reset_fclk1/interconnect_aresetn] [get_bd_pins video/ic_resetn_clk142M]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins image_filters/clk_142M] [get_bd_pins proc_sys_reset_fclk1/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins video/clk_142M]
...
create_root_design ""
make_wrapper -files [get_files ./lab3/lab3.srcs/sources_1/bd/lab3/lab3.bd] -top
add_files -norecurse ./lab3/lab3.srcs/sources_1/bd/lab3/hdl/lab3_wrapper.v
set_property top lab3_wrapper [current_fileset]
import_files -fileset constrs_1 -norecurse ./vivado/constraints/lab3.xdc
