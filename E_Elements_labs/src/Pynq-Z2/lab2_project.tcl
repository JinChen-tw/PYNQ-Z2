...
# source lab2_project.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./lab2_project/lab2_project.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project lab2_project lab2_project -part xc7z020clg400-1
}
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins audio_codec_ctrl_0/s_axi_aresetn] [get_bd_pins clk_wiz_10MHz/resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins video/periph_resetn_clk100M]
...
create_root_design ""
make_wrapper -files [get_files ./lab2_project/lab2_project.srcs/sources_1/bd/lab2_project/lab2_project.bd] -top
add_files -norecurse ./lab2_project/lab2_project.srcs/sources_1/bd/lab2_project/hdl/lab2_project_wrapper.v
set_property top lab2_project_wrapper [current_fileset]
import_files -fileset constrs_1 -norecurse ./vivado/constraints/base_simplify.xdc
